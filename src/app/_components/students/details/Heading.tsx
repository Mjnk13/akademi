...
const Heading = () => {
    return (
        <div className={styles.studentDetails__heading}>
            <h2 className={styles.studentDetails__heading__title}>Student Details</h2>
            <div className={styles.studentDetails__heading__right}>
                <div className={styles.studentDetails__heading__right__search}>
